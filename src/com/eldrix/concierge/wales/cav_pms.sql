...
c1.id coepID,
c1.con_id,
to_char(b1.date_adm, 'yyyy/mm/dd hh24:mi:ss') as date_adm,
to_char(b1.date_disch, 'yyyy/mm/dd hh24:mi:ss') as date_disch,
i1.name ward,
Decode(pers.dod, null, 'N', 'Y' ) deceased,
b1.activity_id,
to_char(b1.date_tci, 'yyyy/mm/dd hh24:mi:ss') as date_tci,
papa.npi,
papa.pathway_type,

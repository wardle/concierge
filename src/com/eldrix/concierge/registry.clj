...
(def namespaces
...

  {
   ...
   :org.hl7.fhir.Address/postal-code                 "http://hl7.org/fhir/Address/postal-code"
...
(defn register-resolver
  ...
  (when (not (contains? well-known-systems system))
    (log/info "warning: resolver registered for namespace" system "not in known namespace list"))
